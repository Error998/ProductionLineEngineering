# Production Line Engineering Mod  

![Production Line Engineering Logo](media/logo.jpg)  
Create a mega factory and use your engineering skills to make the most efficient production line posible.

## Current Status of PLE

PLE (Production Line Engineering) is currently in its conceptionl design stage still. So in essence its just an idea at the moment :) Please do not use this mod in a modpack before its ready for release, or if you like to play with fire feel free to compile the mod on your own.  Follow the details below at your own risk :D

### Compiling from Source Prerequisities
